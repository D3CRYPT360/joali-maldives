  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#f8f3f1] to-[#f7f5f3] flex flex-col items-center">
      ...
      <div className="w-full max-w-6xl mx-auto px-4 py-16 flex flex-col items-center">
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-2 text-center">Book Your Tickets</h1>
        ...
        <div className="flex flex-col md:flex-row gap-8 w-full justify-center">
          ...
          <div className="bg-white rounded-2xl shadow-xl flex flex-col items-center p-8 w-full md:w-80 transition-transform hover:scale-105">
            <div className="mb-4 text-5xl text-orange-400">
              <span role="img" aria-label="ferry">🛳️</span>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl flex flex-col items-center p-8 w-full md:w-80 opacity-80">
            <div className="mb-4 text-5xl text-orange-400">
              <span role="img" aria-label="themepark">🎢</span>
            </div>
            <h2 className="text-xl font-semibold mb-2 text-gray-900">Themepark Events</h2>
            <p className="text-gray-600 mb-6 text-center">Enjoy thrilling rides and unforgettable entertainment.</p>
            <button className="bg-orange-200 text-white font-semibold py-2 px-6 rounded-lg cursor-not-allowed shadow-md" disabled>Coming Soon</button>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl flex flex-col items-center p-8 w-full md:w-80 opacity-80">
            ...
            <h2 className="text-xl font-semibold mb-2 text-gray-900">Beach Events</h2>
            <p className="text-gray-600 mb-6 text-center">Relax, play, and celebrate on our pristine beaches.</p>
            <button className="bg-orange-200 text-white font-semibold py-2 px-6 rounded-lg cursor-not-allowed shadow-md" disabled>Coming Soon</button>
          </div>
        </div>
      </div>
